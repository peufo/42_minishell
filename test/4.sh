...
# env | sort | grep -v SHLVL | grep -v ^_ | grep -v ^GLI | grep -v ^LD_
...
# ifconfig | grep ":" | grep -v RX | grep -v TX
...
# cat log/tmp_lol.c | cat > log/tmp_lol.c
# rm -rf log/tmp_lol.c

# /bin/echo 1 > log/tmp_lol.c
# cat log/tmp_lol.c | cat > log/tmp_lol.c
# rm -rf log/tmp_lol.c
...
# cat < Makefile > log/out >> log/out1 | wc -l log/out1 > log/out2
# cat < Makefile > log/out >> log/out1 | wc -l log/out1 > log/out2
# /bin/rm -f log/out
# /bin/rm -f log/out1
# /bin/rm -f log/out2
